...
This fork (`1.14.6-elimon.3`) is the result of a hard test of upstream `mad-001/Hytale-Takaro-Integration`
...
1. **Get the jar.** Build it (below) or take `HytaleTakaroMod-1.14.6-elimon.3.jar` from a release.
2. **Drop it in the server's mods folder:**
   ```
   <server directory>/mods/HytaleTakaroMod-1.14.6-elimon.3.jar
   ```
...
# -> HytaleTakaroMod/target/HytaleTakaroMod-1.14.6-elimon.3.jar
```
